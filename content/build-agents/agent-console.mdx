---
title: "Agent Console"
description: "Agent Console guidance for build agents in Ribbon."
---

Agent Console guidance for build agents in Ribbon.

## Overview

This page covers **agent console** as part of the Build Agents section. Replace this
...
- Understand how agent console fits into build agents.
