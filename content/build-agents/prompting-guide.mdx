...
description: "Prompting Guide guidance for build agents in Ribbon."
---

Prompting Guide guidance for build agents in Ribbon.

## Overview

This page covers **prompting guide** as part of the Build Agents section. Replace this
...
- Understand how prompting guide fits into build agents.
