...
description: "Logic Overview guidance for build agents in Ribbon."
---

Logic Overview guidance for build agents in Ribbon.
...
- Understand how logic overview fits into build agents.
