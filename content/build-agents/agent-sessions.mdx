...
description: "Agent Sessions guidance for build agents in Ribbon."
---

Agent Sessions guidance for build agents in Ribbon.

## Overview

This page covers **agent sessions** as part of the Build Agents section. Replace this
...
- Understand how agent sessions fits into build agents.
