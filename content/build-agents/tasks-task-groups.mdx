---
title: "Tasks & task groups"
description: "Tasks Task Groups guidance for build agents in Ribbon."
---

Tasks Task Groups guidance for build agents in Ribbon.

## Overview

This page covers **tasks & task groups** as part of the Build Agents section. Replace this
...
- Understand how tasks task groups fits into build agents.
