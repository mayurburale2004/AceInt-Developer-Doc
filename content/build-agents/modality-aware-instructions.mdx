...
description: "Modality Aware Instructions guidance for build agents in Ribbon."
---

Modality Aware Instructions guidance for build agents in Ribbon.

## Overview

This page covers **modality-aware instructions** as part of the Build Agents section. Replace this
...
- Understand how modality aware instructions fits into build agents.
