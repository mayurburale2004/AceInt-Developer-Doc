...
description: "Text Transcriptions guidance for build agents in Ribbon."
---

Text Transcriptions guidance for build agents in Ribbon.

## Overview

This page covers **text & transcriptions** as part of the Build Agents section. Replace this
...
- Understand how text transcriptions fits into build agents.
