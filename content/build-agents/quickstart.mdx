...
description: "Quickstart guidance for build agents in Ribbon."
---

Quickstart guidance for build agents in Ribbon.

## Overview

This page covers **voice ai quickstart** as part of the Build Agents section. Replace this
...
- Understand how quickstart fits into build agents.
