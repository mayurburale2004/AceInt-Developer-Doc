---
title: "CLI reference"
description: "Cli Reference guidance for api reference in Ribbon."
---

Cli Reference guidance for api reference in Ribbon.

## Overview

This page covers **cli reference** as part of the API Reference section. Replace this
...
- Understand how cli reference fits into api reference.
