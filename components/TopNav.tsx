...
export function TopNav() {
  ...
  <span className="text-xl font-bold tracking-tight text-blue-600">AceInt</span>
</Link>
        </div>
        ...
        <button
          ...
          className="mx-auto hidden w-full min-w-0 max-w-md items-center gap-2 rounded-lg border border-ink-200 bg-ink-100/60 px-3 py-2 text-sm text-ink-500 hover:border-ink-300 sm:flex"
        >
          <Search size={16} />
